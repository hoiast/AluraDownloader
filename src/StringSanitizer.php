...
class StringSanitizer
{
    ...
    {
        $normalizedString = self::toAscii($string);
        $sanitizedString = self::removeSpecialCharacters($normalizedString);
    ...
    /**
     * Remove characters that may conflict with filesystem naming conventions
     * @param string $string
     * @return string
     */
